...
import com.mohbou.testingjunitapplication.test.RecipeRobot;
...
public class RecipeActivityTest {
    ...
    public void clickToFavorite() {
        ...
        onView(withId(R.id.announcement)).check(matches(withText("Creamed Carrots")))
    ...
    public void alreadyFavorite() {
        ...
        new RecipeRobot().setFavorite(CARROTS_ID).launch(activityRule, CARROTS_ID).isFavorite();
